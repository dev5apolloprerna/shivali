                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h4 class="card-title mb-0">Top Video Listing</h4>
                                        ...
                                        @forelse($TopVideo as $TVideo)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('TopVideo.delete', $TVideo->id) }}"
            ...
            <form method="POST" id="editCategoryForm" enctype="multipart/form-data" action="">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Top Video</h5>
...
@section('scripts')
    ...
    <script>
        ...
        $('.edit-btn').on('click', function() {
            ...
            $('#editCategoryForm').attr('action', "{{ route('TopVideo.update', ':id') }}".replace(':id', id));
