                                    ...
                                    <form method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select id="jsCategory" name="category_id"
                                                    class="form-select @error('category_id') is-invalid @enderror"
                                                    data-selected="{{ $selectedCategory }}">
                                                    <option value="">-- Select Category --</option>
                                                    @foreach ($categories as $id => $name)
                                                        <option value="{{ $id }}" @selected($selectedCategory == $id)>
                                                            {{ $name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('category_id')
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @error('subcategory_id')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <div class="form-text" id="jsSubcatHelp" style="display:none;">Loading
                                                    subcategories…</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="tag_ids[]" id="jsTags" class="form-select" multiple>
                                                    @foreach ($tags as $id => $name)
                                                        <option value="{{ $id }}"
                                                            @if (!empty($selectedTags) && in_array($id, $selectedTags)) selected @endif>
                                                            {{ $name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="product_name"
                                                    ...
                                                    placeholder="Enter product name" id="jsProductName">
                                                @error('product_name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                                <div class="form-text">
                                                    Slug: <span class="fw-semibold" id="jsSlugPreview">
                                                        @if (isset($row) && $row->slug)
                                                            {{ $row->slug }}
                                                        @else
                                                            <span class="text-muted">Generated on save</span>
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                @if (!empty($row?->product_image))
                                                    <div class="mt-2">
                                                        <img src="{{ asset($row->product_image) }}" alt="image"
                                ...
                                <div class="card-footer mt-5" style="float: right;">
                                    @if (!isset($row))
                                        ...
                                        @else
                                            ...
                                            <a class="btn btn-light float-right mr-3 mb-3 mx-2"
    ...
    <script>
        (function() {
            ...
            nameInput.addEventListener('input', function() {
                ...
                if (!v) preview.classList.add('text-muted');
                else preview.classList.remove('text-muted');
            });
        })();
        ...
        (function() {
            ...
            async function loadSubcategories(categoryId, preselectId) {
                ...
                if (helpTxt) {
                    ...
                    helpTxt.textContent = 'Loading subcategories…';
                }
