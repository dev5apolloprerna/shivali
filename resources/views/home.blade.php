                    ...
                    <div class="col">
                        ...
                        <div class="h-100">
                            ...
                            <div class="row">
                                    ...
                                    <a href="{{ route('admin.category.index') }}" class="text-decoration-none text-dark">
                                        ...
                                        <div class="card text-center shadow-sm border-0">
                                            <div class="card-body">
                                                ...
                                                <h3 class="mb-0">{{ $counts['categories'] }}</h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <a href="{{ route('admin.sub-category.index') }}"
                                        ...
                                        <div class="card text-center shadow-sm border-0">
                                            <div class="card-body">
                                                ...
                                                <h3 class="mb-0">{{ $counts['subcategories'] }}</h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <a href="{{ route('Inquiry.index') }}" class="text-decoration-none text-dark">

                                        <div class="card text-center shadow-sm border-0">
                                            <div class="card-body">
                                                <i class="fas fa-envelope-open-text fa-2x text-danger mb-2"></i>
                                                <h6 class="fw-bold mb-1">Inquiries</h6>
                                                <h3 class="mb-0">{{ $counts['inquiries'] }}</h3>
                                            </div>
                                        </div>
                                    </a>
                                </div>
